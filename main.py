...
Original file is located at
    https://colab.research.google.com/drive/1f9ho1C9_z_KLpetmGFo280YufU5ge9-s
"""
...
class Data:
    ...
    # CNN model
    cnn_model = CNN_model()
    result = cnn_model.fit(training_sample, training_labels, epochs=40, validation_data=(test_samples, test_labels))
    ...
    plot_graph(testing_loss, "Testing Loss", "Number of Epoch", "Loss")
